#!/bin/bash
# ==============================================================================
# Pipeline wrapper script for Annotation execution.
...
# ==============================================================================
# EXIT CODE SCHEME
# exit 1 -> failure of python3 annotation.py execution
# ==============================================================================
...
if [ $cmd_exit_code -ne 0 ]; then
    log_error "Python execution of pca.py failed with exit code $cmd_exit_code."
    exit 1
fi
